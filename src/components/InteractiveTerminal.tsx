...
const COMMANDS: Record<string, string[]> = {
  ...
  experience: [
    '  [Current] Web Developer Intern @ Webninjaz Technologies',
    '           — React, Next.js, API Integration, Python automation',
    '',
    '  [2024]    Full Stack Development Training @ JOVAC',
    '           — Full stack apps, Node.js, JS, HTML/CSS, Git',
    '',
    '  [Ongoing] B.Tech CSE Student @ GLA University',
    '           — Systems foundations, DSA, algorithms, web dev',
  ],
  contact: [
